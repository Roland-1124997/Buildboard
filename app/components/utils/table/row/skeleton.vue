	...
	<tr v-if="isOpen" :class="isSmall ? '' : 'md:hidden'">
		<td :colspan="categories.length" class="text-xs text-gray-600" role="region">
			<table class="min-w-full">
				...
				<tbody class="">
					<tr class="">
						<td v-for="category in categories.slice(1, categories.length - 2)" :key="category.value" :class="isOpen ? 'py-[0.86rem]' : 'py-[0.86rem] md:py-3'" class="text-sm text-center text-gray-700 border-t border-l first:border-l-0 whitespace-nowrap">
