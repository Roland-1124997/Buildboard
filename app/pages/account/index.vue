<template>
	<div class="relative z-10">
		...
		<button v-if="user.data.data.factors" @click="deleteData" class="px-4 py-2 ml-4 text-white bg-red-500 rounded">
			Verwijder TOTP Gegevens
		</button>

		<button v-else @click="postData" class="px-4 py-2 text-white bg-blue-500 rounded">
			Genereer TOTP Gegevens
		</button>
		...
		<div>
			<div v-if="result" class="p-4 mt-6 border border-gray-200 rounded bg-gray-50">
				...
				<p class="mt-2"><strong>URI:</strong> 
				...
				<NuxtLink to="/auth/totp" class="inline-block px-4 py-2 mt-4 text-white bg-green-500 rounded">
					Verifieer TOTP Code
				</NuxtLink>
